...
namespace Dominio.algo
{
    ...
    public class ManejadorDB
    {
        ...
        private DBAcceso dbAccesoInterno;
        ...
        public ManejadorDB(String cadenaConexion)
        {
            try
            {
                ...
                dbAccesoInterno = new DBAcceso(cadenaConexion);
                CargarConexionesDeServidor();
            }
        ...
        public void GuardarObjetosModificados()
        {
            try
            {
                ...
                foreach (ObjetoBase objetoBase in objetosModificados)
                {
                    if (objetoBase.Id >= 0)
                    {
                        objetoBase.DBAccesoOBJ = this.dbAcceso;
        ...
        public DateTime ObtenerFechaHoraServidor()
        {
            try
            {
                ...
                DataTable dt = dbAccesoInterno.EjecutarConsulta(query);
