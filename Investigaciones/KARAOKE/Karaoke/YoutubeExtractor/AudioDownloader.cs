...
namespace YoutubeExtractor
{
    ...
    public class AudioDownloader : Downloader
    {
        ...
        public AudioDownloader(VideoInfo video, string savePath, String folder, int? bytesToDownload = null)
        ...
        {
            string tempPath = this.Folder+"\\"+DateTime.Now.ToString("yyyyMMddHHmmss")+".tmp"; //Path.GetTempFileName();

            this.DownloadVideo(tempPath, Folder);
        ...
        private void DownloadVideo(string path, String folder)
        {
            var videoDownloader = new VideoDownloader(this.Video, path, folder, this.BytesToDownload);
