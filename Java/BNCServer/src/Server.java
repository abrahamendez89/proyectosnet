	...
	public static void main(String[] args) {
		...
		try {
			...
			socket.on(Socket.EVENT_CONNECT, new Emitter.Listener() {
				...
				@Override
				public void call(Object... args) {
					String entrada = args[0].toString();

					int codigo = Integer.parseInt(entrada.split(",")[0]);
					String letra = entrada.split(",")[1];

					int convertido = convert(letra.charAt(0));
					System.out.println(letra+" "+convertido);
					if (convertido == -1)
						convertido = codigo;
