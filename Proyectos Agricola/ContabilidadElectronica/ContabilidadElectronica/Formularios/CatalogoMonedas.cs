...
namespace ContabilidadElectronica.Formularios
{
    public partial class CatalogoMonedas : Form
    {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            String queryBuscar = "select codigoMoneda from empresas..ELEC_CATALOGO_MONEDAS where codigoMoneda = '" + txt_codigo.Text.Trim() + "'";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                query = @"update 
                          empresas..ELEC_CATALOGO_MONEDAS
                           set DescripcionMoneda = @descripcion	
                          	,EstaActivo = @estaActivo
                          where codigoMoneda = '" + txt_codigo.Text.Trim() + @"'
                        ";
            ...
            {
                query = "insert into empresas..ELEC_CATALOGO_MONEDAS(codigoMoneda, DescripcionMoneda,EstaActivo) values(@codigo, @descrip, @estaActivo)";
        ...
        {
            String query = "select codigoMoneda as [Código], DescripcionMoneda as [Descripción], estaActivo as [Está activo]  from empresas..ELEC_CATALOGO_MONEDAS";
