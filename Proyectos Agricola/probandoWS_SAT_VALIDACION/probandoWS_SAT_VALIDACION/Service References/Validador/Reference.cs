...
namespace probandoWS_SAT_VALIDACION.Validador {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Validador.IConsultaCFDIService")]
    public interface IConsultaCFDIService {
        ...
        probandoWS_SAT_VALIDACION.Validador.Acuse Consulta(string expresionImpresa);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IConsultaCFDIService/Consulta", ReplyAction="http://tempuri.org/IConsultaCFDIService/ConsultaResponse")]
        System.Threading.Tasks.Task<probandoWS_SAT_VALIDACION.Validador.Acuse> ConsultaAsync(string expresionImpresa);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IConsultaCFDIServiceChannel : probandoWS_SAT_VALIDACION.Validador.IConsultaCFDIService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ConsultaCFDIServiceClient : System.ServiceModel.ClientBase<probandoWS_SAT_VALIDACION.Validador.IConsultaCFDIService>, probandoWS_SAT_VALIDACION.Validador.IConsultaCFDIService {
        ...
        public probandoWS_SAT_VALIDACION.Validador.Acuse Consulta(string expresionImpresa) {
            return base.Channel.Consulta(expresionImpresa);
        }
        
        public System.Threading.Tasks.Task<probandoWS_SAT_VALIDACION.Validador.Acuse> ConsultaAsync(string expresionImpresa) {
