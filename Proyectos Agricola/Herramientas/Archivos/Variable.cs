...
namespace Herramientas.Archivos
{
    public class Variable
    {
        ...
        public T ObtenerValorVariable<T>(String variable)
        {
            if (diccionario.ContainsKey(variable))
            {
                try
                {
                    ...
                    {
                        if (diccionario[variable].Trim().ToLower().Equals("si"))
                            return (T)Convert.ChangeType(true, typeof(T));
                        else if (diccionario[variable].Trim().ToLower().Equals("no"))
        ...
        public void GuardarValorVariable(String variable, int valor)
        {
            GuardarValorVariable(variable, valor.ToString());
        }
        public void GuardarValorVariable(String variable, double valor)
        {
            GuardarValorVariable(variable, valor.ToString());
        }
        public void GuardarValorVariable(String variable, Boolean valor)
        {
            String text = "";
            if(valor)
                text = "si";
                ...
                text = "no";
            GuardarValorVariable(variable, text);
        }
        public void GuardarValorVariable(String variable, String valor)
        {
            //LeerArchivo();
