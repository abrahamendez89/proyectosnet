...
namespace OneDrive.API
{
    public class OneDriveAPI
    {
        ...
        public delegate void EnvioTerminado();
        ...
        public void SubirArchivoACarpeta(String rutaArchivoSubir, String nombreCarpetaOneDrive)
        {
            ...
            {
                if (error != null)
                    error(new Exception("Ocurrió un error al intentar loguearse.", ex));
            }
        }
        ...
        void wb_DocumentCompleted(object sender, WebBrowserDocumentCompletedEventArgs e)
        {
            try
            {
                ...
                else if (wb.Document.Url.ToString().ToLower().Contains("consent"))
                {
        ...
        private String CrearCarpeta(String nombreCarpeta)
        {
            try
            {
                ...
                api.ByteData = System.Text.Encoding.ASCII.GetBytes(jsonTemp);
                dynamic drive = api.HacerPeticion();
                return drive.id;
