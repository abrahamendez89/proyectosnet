...
#Region "Metodos"
    ...
    Public Function Timbra(ByVal prmRutaXML As String, ByVal prmID As String, ByVal prmDestinoXML As String, _
                           ...
                           ByVal prmRFCReceptor As String, ByVal prmTotal As Decimal, ByVal prmCadenaOriginal As String, ByVal prmNombreID As String, ByVal nRFCEmisor As Int32) As String
        ...
        Try
            ...
            'Respuesta = ServicioFD.TimbrarPruebaCFDI(vcUsuarioWS, vcPasswordWS, vcCadenaXML)
            ...
            If Respuesta(0).ToString = "" And Respuesta(1).ToString = "" And Respuesta(2).ToString = "" Then
                ...
                vcResultActualiza = flActualizaTimbrado(prmID, prmRutaBidimensional, prmRFCEmisor, prmRFCReceptor, prmTotal, prmCadenaOriginal, nRFCEmisor)
    ...
    Public Function Cancela(ByVal prmID As Long) As String()
        ...
        If vlUUIDCancelacion <> "" Then
            ...
            Dim resp1 As String() = Respuesta(1).Split("|")

            If Respuesta(0).Contains("Error") Then
                Return {Respuesta(0), ""}
            End If

            If resp1.Length = 1 Then
                Return {Respuesta(0), ""}
            End If


            Dim resp As String = resp1(2)

            ' en caso de que el timbrado haya sido con exito
            If resp.Trim().ToLower().Contains("uuid previamente cancelado") Then
                Return {resp, Respuesta(2)}
            ElseIf resp.Trim().ToLower().Contains("uuid cancelado") Then
                Return {resp, Respuesta(2)}
            Else
                Return {resp, ""}
            End If
    ...
    Public Function RecuperaXML(ByVal prmFactura As String, ByVal prmUUID As String, ByVal prmRFC As String) As String

        Dim ServicioFD As New WSFD.WS_FD_TFDSoapClient
        Dim vObjCabecera As New Access.DatosCab

        vObjCabecera = Access.FabricaDatosCFDI32.ObtenDatosEncabezado(prmFactura)
        Respuesta = ServicioFD.ObtenerXML(vObjCabecera.UsuarioWS, vObjCabecera.PasswordWS, prmUUID, prmRFC)

        If Respuesta(3).ToString().Equals("") Then
            Return "Error: " & Respuesta(1)
        End If
    ...
    Public Function RecuperaXML(ByVal UsuarioWS As String, ByVal PasswordWS As String, ByVal prmUUID As String, ByVal prmRFC As String) As String

        Dim ServicioFD As New WSFD.WS_FD_TFDSoapClient
        Dim vObjCabecera As New Access.DatosCab

        Respuesta = ServicioFD.ObtenerXML(UsuarioWS, PasswordWS, prmUUID, prmRFC)
...
#Region "Funciones Privadas"
    ...
    Private Function ActualizaFechaCancelacion(ByVal prmID As Long) As String
        ...
        Dim sSel As String = "SELECT * FROM EMPRESAS..FAC_CFDI WHERE NFACTURA = " & prmID
        '
    ...
    Private Function flActualizaTimbrado(ByVal prmID As String, ByVal prmRutaBidimensional As String, _
                                         ...
                                         ByVal prmCadenaOriginal As String, ByVal nRFCEmisor As Int32) As String
        ...
        Try
            ...
            ' La cadena de selección
            Dim sSel As String = "SELECT * FROM EMPRESAS..FAC_CFDINOMINA WHERE nfactura = '" & prmID & "'"
            '
            ' Comprobar si hay algún error
