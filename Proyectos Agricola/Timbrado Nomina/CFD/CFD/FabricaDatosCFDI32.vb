...
Namespace Access
    Public Class FabricaDatosCFDI32
        Private Shared dbAcceso As Herramientas.SQL.SQLServer
        Public Shared Function ObtenDatosEncabezado(ByVal prmID As Long) As DatosCab
            ...
            Dim prmIDs As String = prmID.ToString
            'prmIDs = prmIDs.Substring(0, prmIDs.Length - 1)

            vcSQL = "SELECT * FROM Empresas..VW_ENCABEZADOXMLCFDI32NOMINA(NOLOCK)" & vbCrLf
            vcSQL = vcSQL & "WHERE nfactura = '" & prmIDs & "'"
            ...
            If Not DT Is Nothing AndAlso DT.Rows.Count > 0 Then
                ...
                ret.nFactura = IIf(vRow("nFactura") Is DBNull.Value, "", vRow("nFactura"))
                ...
                If Not ret.SelloCancelacion.Trim().Equals("") Then
                    ret.SelloCancelacion = Convert.ToBase64String(System.IO.File.ReadAllBytes(ret.SelloCancelacion))
                End If
                ret.PassCancelacion = IIf(vRow("EMPPASSCANC") Is DBNull.Value, "", vRow("EMPPASSCANC"))

                ret.RutaUtileria = IIf(vRow("RUTAUTILERIACADENAORIGINAL") Is DBNull.Value, "", vRow("RUTAUTILERIACADENAORIGINAL"))
            Else
                Return Nothing
            End If
            Return ret
        ...
        Public Shared Function ObtenDatosCabeceroNomina(ByVal prmID As String) As DataTable
            ...
            vcSQL = "SELECT * FROM VW_FAC_ENCABEZADOCFDINOM(NOLOCK)" & vbCrLf
            vcSQL = vcSQL & "WHERE ID = " & prmID
